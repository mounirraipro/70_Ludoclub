...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About Ludo Club',
        url: 'https://ludoclub.online/about',
        description: 'Learn about Ludo Club, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
            name: 'Ludo Club',
...
export const metadata: Metadata = {
    title: 'About Us – Ludo Club',
    description: 'Learn about Ludo Club, our mission, and the team behind the game.',
    keywords: ['about Ludo Club', 'game team', 'who made Ludo Club'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About Ludo Club</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    Ludo Club was born from a simple idea: what if playing Ludo Club could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched Ludo Club with a clear vision — to create a free, accessible, and
                    ...
                    Ludo Club has something for you.
                </p>
                ...
                <p>
                    Every level in Ludo Club is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    Ludo Club offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make Ludo Club better for
                    everyone.
                </p>
            </div>
        </>
