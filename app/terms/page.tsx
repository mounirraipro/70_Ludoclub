...
export const metadata: Metadata = {
    ...
    description: 'Read the Ludo Club Terms of Service. Understand the rules and guidelines for using our free online game.',
    keywords: ['Ludo Club terms of service', 'terms and conditions', 'usage agreement'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    Welcome to Ludo Club. By accessing or using our website and game, you agree to be
                    bound by these Terms of Service. Please read them carefully before using our services.
                </p>

                <h2>1. Acceptance of Terms</h2>
                <p>
                    By accessing Ludo Club at ludoclub.online, you acknowledge that you have read,
                ...
                <p>
                    Ludo Club provides a free, browser-based game. Ludo Club is a free, browser-based game experience.
                    The service includes the game itself, educational content, blog articles, and related resources.
                </p>

                <h2>3. User Eligibility</h2>
                <p>
                    Ludo Club is available to users of all ages. However, users under 13 years of age
                ...
                <p>
                    All content on Ludo Club — including but not limited to the game design, code, images,
                    text, graphics, logos, and audio — is the intellectual property of Ludo Club or its
                ...
                <p>
                    ...
                    Ludo Club for personal, non-commercial purposes only.
                </p>

                <h2>5. Acceptable Use</h2>
                <p>When using Ludo Club, you agree NOT to:</p>
                <ul>
                ...
                <p>
                    ...
                    grant Ludo Club a non-exclusive, royalty-free, perpetual license to use, modify,
                    and incorporate that content into our services.
                </p>

                <h2>7. Advertisements</h2>
                <p>
                    Ludo Club displays advertisements from third-party ad networks, including Google
                ...
                <p>
                    Ludo Club is provided &ldquo;as is&rdquo; and &ldquo;as available&rdquo; without warranties of any
                ...
                <p>
                    To the fullest extent permitted by law, Ludo Club and its operators shall not be
                ...
                <p>
                    We reserve the right to suspend or terminate your access to Ludo Club at our sole
                ...
                <p>
                    ...
                    <strong>legal@ludoclub.online</strong>.
                </p>
            </div>
        </>
    );
