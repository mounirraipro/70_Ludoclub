...
const SUPPORT_EMAIL = 'hello@ludoclub.online';

export const metadata: Metadata = {
    title: 'Contact Ludo Club',
    description: 'Get in touch with the Ludo Club team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Ludo Club', 'Ludo Club support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
