...
export const metadata: Metadata = {
    ...
    description: 'Ludo Club is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Ludo Club accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Ludo Club accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Ludo Club is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Ludo Club presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Ludo Club. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@ludoclub.online</strong></li>
                </ul>
                <p>
