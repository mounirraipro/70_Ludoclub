...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Ludo Club. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Ludo Club sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Ludo Club' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Ludo Club?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Ludo Club.</p>
                </div>
            </div>
