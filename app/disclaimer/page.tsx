...
export const metadata: Metadata = {
    title: 'Disclaimer',
    description: 'Read the Ludo Club disclaimer regarding website content accuracy, external links, and general use of our free online game.',
    keywords: ['Ludo Club disclaimer', 'website disclaimer', 'legal disclaimer'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    The information provided by Ludo Club (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) on ludoclub.online
                ...
                <p>
                    Ludo Club is a browser-based entertainment product provided free of charge. The game
                ...
                <p>
                    Ludo Club displays third-party advertisements (including Google AdSense ads) to
                    ...
                    an endorsement or recommendation by Ludo Club.
                </p>
                ...
                <p>
                    ...
                    has been obtained from reliable sources, Ludo Club is not responsible for any errors
