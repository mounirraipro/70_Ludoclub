...
const SITE_URL = 'https://ludoclub.online';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Ludo Club',
        url: SITE_URL,
        description: 'Play Ludo Club free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Ludo Club online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
